...
\begin{tikzpicture}[remember picture,overlay]
	...
	\node[opacity=1,inner sep=0pt] at ($(current page.center)+(0cm,-3cm)$){\includegraphics[height=2cm]{../figs/00_misc/logo-sprep.png}};
\end{tikzpicture}
