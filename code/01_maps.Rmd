...
data_text_tropics <- tibble(long = c(-104, -104, -119, -128),
                    lat = c(-21.43, -25.43, 2, 25.43),
                    text = c("Tropic of", "Capricorne", "Equator", "Tropic of Cancer")) %>% 
  st_as_sf(coords = c("long", "lat"), crs = 4326) %>% 
  st_transform(crs_selected)
...
ggsave(filename = "../figs/01_global-map-pacific.png", width = 8, height = 7.75, dpi = 600)
