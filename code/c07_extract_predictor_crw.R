...
ncdf_files <- list.files("data/07_crw_year/", full.names = TRUE) %>% 
  as_tibble() %>% 
...
write.csv(pred_ssta_max, file = "data/10_predictors/pred_ssta_max.csv", row.names = FALSE)
...
write.csv(pred_ssta_mean, file = "data/10_predictors/pred_ssta_mean.csv", row.names = FALSE)
...
write.csv(pred_sst_min, file = "data/10_predictors/pred_sst_min.csv", row.names = FALSE)
...
write.csv(pred_sst_mean, file = "data/10_predictors/pred_sst_mean.csv", row.names = FALSE)
...
write.csv(pred_sst_max, file = "data/10_predictors/pred_sst_max.csv", row.names = FALSE)
