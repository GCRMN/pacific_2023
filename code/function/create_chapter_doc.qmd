...
**Figure 2.`r nb_chapter`.5.** Modeled temporal trends for hard coral (**A**), coralline algae (**B**), macroalgae (**C**), and turf algae (**D**) cover from 1990 to 2022 in `r territory_i`. The bold line represents the estimated average cover, lighter and darker ribbons represent 95% and 80% confidence intervals, respectively. Gray areas represent periods where no observed data were available.
