...
The long-term average of SST on coral reefs of `r territory_i` between 1985 and 2023 was `r mean_sst`°C (**Supplementary Figure 1A**). SST over coral reefs of `r territory_i` have increased by `r sst_increase`°C between 1985 and 2023, which corresponds to a warming rate of `r warming_rate`°C per year (**Supplementary Figure 1A**).
