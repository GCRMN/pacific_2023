...
data_eez <- tibble(number = 1:30,
                   lat = c(5, 7, 13, 20, 10, 19.5, 27, 17, -3, -1,
                           -10, -18, -21, -21, -13.5, -8, -1, 1, -5,
                           -9, -15, -13, -23, -19, -18.5, -20, 7, -1, -9.5,
                           -24.5),
                   long = c(133, 150, 144, 144.5, 168, 167, -175, -169, 150, 166,
                            165, 170, 160, 177, -178, 178, 174, -176, -175,
                            -172, -168, -172, -176, -169, -161, -145, -163, -160.5, -151,
                            -127)) %>% 
  left_join(data_eez, .)
