...
\usepackage[colorlinks=true,citecolor=firstcolor,urlcolor=secondcolor,linkcolor=black]{hyperref}
\usepackage{titlesec}
\usepackage{graphicx}
\usepackage{caption}
...
\definecolor{firstcolor}{HTML}{5C53A5}
\definecolor{secondcolor}{HTML}{CE6693}
...
\fancyfoot[LE,RO]{\sffamily\footnotesize \textcolor{secondcolor}{\thepage}}
...
\textbf{GCRMN} \textcolor{firstcolor}{Global Coral Reef Monitoring Network}

\href{www.gcrmn.net}{www.gcrmn.net}
	
\vspace{0.5cm}

\textbf{ICRI} \textcolor{firstcolor}{International Coral Reef Initiative}
...
Serge & Planes   &         \contrib          &     \contrib      &                         &                        &                        &                     &                          &                                 \\ \hline
	\rowcolor{colortable2} Jérémy & Wicquart &                           &                   &                         &                        &        \contrib        &                     &                          &                                 \\ \hline
\end{tabular}
	\end{center}
