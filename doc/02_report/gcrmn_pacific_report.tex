...
\definecolor{Couleur2}{HTML}{6C7A89} % Couleur secondaire (gris foncé)
\definecolor{Couleur3}{HTML}{BDC3C7} % Couleur terciaire (gris clair)
\definecolor{Couleur4}{HTML}{ECF0F1} % Couleur de fond en-tête
...
% Thème B - Notes, classements et durée des activités de recherche
...
\href{https://gcrmn.net/}{Global Coral Reef Monitoring Network} (GCRMN)

\href{https://icriforum.org/}{International Coral Reef Initiative} (ICRI)

\vspace{5cm}

\textcolor{colortable3}{Cite this report as:}

Wicquart J. and Planes S. (eds.), 2023. Status and Trends of Coral Reefs of the Pacific.\\Global Coral Reef Monitoring Network and International Coral Reef Initiative.

\vspace{3cm}

\textcolor{colortable3}{Photo credits:}

\hspace{0.5cm} \textbf{Front cover}. Hannes Klostermann. Coral reefs in Moorea, French Polynesia.

\hspace{0.5cm} \textbf{Pages 25 and 26}. Hannes Klostermann. Coral reefs in Moorea, French Polynesia.

\hspace{0.5cm} \textbf{Pages 77 and 78}. Hannes Klostermann. Coral reefs in Moorea, French Polynesia.

\hspace{0.5cm} \textbf{Back cover}. Hannes Klostermann. Coral reefs in Moorea, French Polynesia.
...
{\fontsize{40pt}{40pt}\selectfont \textcolor{white}{\textbf{PART 2}}}

\vspace{0.5cm}

{\fontsize{30pt}{40pt}\selectfont \textcolor{white}{Syntheses for countries and territories}}
...
\begin{tikzpicture}[remember picture,overlay]
	\filldraw[color=white, fill=colortable1, fill opacity=0.8, draw opacity=0.8] ($(current page.north west)+(3cm,-5cm)$) rectangle ($(current page.south east)+(-3cm,15cm)$) ;
\end{tikzpicture}

\vspace{6cm}

\hspace{5cm} \textbf{1)} Introduction Blabalalalalala

\hspace{5cm} \textbf{2)} Disturbance regime Blabalalalalala

\hspace{5cm} \textbf{3)} Benthic cover trends Blabalalalalala
...
\textcolor{white}{Gilles Siu\textsuperscript{\textit{1}}, Yannick Chancerelle\textsuperscript{\textit{1}}, Serge Planes\textsuperscript{\textit{1}}, Jérémy Wicquart\textsuperscript{\textit{2}}}

\vspace{0.4cm}

{\scriptsize \textsuperscript{\textcolor{colormain}{\textit{1}}}Laboratoire d'Excellence CORAIL, CRIOBE-USR 3278 CNRS-EPHE-UPVD, BP 1013, Papetoai, Moorea,\\French Polynesia \textcolor{colormain}{\ding{120}} \textsuperscript{\textcolor{colormain}{\textit{2}}}MAREPOLIS, 68 avenue des Corbières, 11490 Portel-Des-Corbières, France}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=10cm]{02_part-2/fig-6/french-polynesia}
	\caption[Maximum sustained wind speed of cyclones within 100 km of a coral reef between 1980 and 2023 over the territory of French Polynesia.]{Maximum sustained wind speed of cyclones within 100 km of a coral reef between 1980 and 2023 over the territory of French Polynesia. Colors correspond to the cyclone category on the Saffir-Simpson scale. The values of sustained wind speed are extracted from the nearest tropical storms position from a coral reef. For this reason, some sustained wind speed values are below the lower threshold of category 1 Saffir-Simpson scale (i.e. 119 km/h).}
	\label{chapter1:fig6}
\end{figure}
