...
\begin{figuremulticol}
	\centering
	\includegraphics[width=\linewidth]{../../figs/02_part-2/fig-3/\territoryname.png}
	\captionof{figure}{Sea Surface Temperature (SST) over coral reefs of French Polynesia between 1985 and 2023. Each line, colored by its associated decade, correspond to a unique year. The black line represents the interannual average SST from 1985 to 2023.}
	\label{part2:chap2:fig-1}
\end{figuremulticol}

\lipsum[1-3]

\input{../../figs/02_part-2/tbl-2/\territoryname.tex}
